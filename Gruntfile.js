		...
		concat: {
			...
			build: {
				src: [
					...
					// we need this dependency first before angular-chart dependency
					'app/assets/libs/chart.js/Chart.js',
					// we need this dependency first before an other dependency
					'app/assets/libs/jquery/jquery.js',
					// dont put two stars here !!! please
					'app/assets/libs/*/*.js'
				],
